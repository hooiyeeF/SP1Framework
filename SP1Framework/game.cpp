...
void init( void )
{
    ...
    Gtimer = 5;
    bool musicplayed = PlaySound(TEXT("C:/Users/joelr/Source/Repos/hooiyeeF/SP1Framework/SP1Framework/Debug/Music/BGM.wav"), NULL, SND_ASYNC | SND_FILENAME | SND_LOOP);
}
